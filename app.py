...
st.title("내부 링크 크롤러")
st.markdown("**크롤링한 데이터를 편집하여 학습자료로 활용합니다.**")
...
st.write("내부 링크만 수집한 후, 편집된 데이터를 동일한 형식으로 저장합니다.")
    ...
    if not base_url:
        ...
        def crawl_content(url):
            ...
            try:
                ...
                return {"url": url, "content": clean_text(content)}
            except Exception as e:
